...
return array(
	...
	'testmode' => array(
		...
		'default'     => 'no',
		'description' => sprintf( __( 'Enable eSewa sandbox to test payments. Sign up for a developer account %shere%s.', 'woocommerce-esewa' ), '<a href="https://uat.esewa.com.np/" target="_blank">', '</a>' )
	),
	'debug' => array(
